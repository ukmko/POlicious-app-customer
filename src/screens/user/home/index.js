...
const HomeScreen = () => {
  ...
  return (
    ...
    <View style={{ position: 'relative' }}>
      ...
      />
      <View style={{ flex: 1, width: '100%', height: 20, zIndex: 999, position: 'absolute', top: 0}}>
        <View style={{ flexDirection: 'row', backgroundColor: Colors.white, width: '100%', marginHorizontal: Metrics.bigMargin, marginTop: 50, height: 200 }}>
          <Text>Point</Text>
          <Text>0</Text>
          <Text>Promo</Text>
        </View>
